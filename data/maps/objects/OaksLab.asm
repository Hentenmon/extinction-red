...
OaksLab_Object:
	...
	def_object_events
	object_event  4,  3, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_OAKSLAB_RIVAL, OPP_RIVAL1, 1
	...
	object_event  5,  2, SPRITE_BLUE, STAY, DOWN, TEXT_OAKSLAB_OAK1
	...
	object_event  5, 10, SPRITE_BLUE, STAY, UP, TEXT_OAKSLAB_OAK2
