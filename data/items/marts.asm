...
CeladonMart2FClerk2Text::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_HEADBUTT, TM_ROOST, TM_DRAIN_PUNCH, TM_SHOCK_WAVE, TM_AERIAL_ACE, TM_SUPERPOWER, TM_FLAMETHROWER
...
CeladonMart5FClerk1Text::
	script_mart UPGRADE, ICE_STONE, SUN_STONE, LINK_CABLE, KINGS_ROCK
...
IndigoPlateauLobbyClerkText::
	script_mart ULTRA_BALL, GREAT_BALL, FULL_RESTORE, MAX_POTION, FULL_HEAL, REVIVE, MAX_REPEL, DUBIOUSDISC
