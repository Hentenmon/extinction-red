TypeEffects:
    ...
    db POISON2,       GRASS,        SUPER_EFFECTIVE
	db POISON2,       POISON,       NOT_VERY_EFFECTIVE
	db POISON2,       GROUND,       NOT_VERY_EFFECTIVE
	db POISON2,       ROCK,         NOT_VERY_EFFECTIVE
	db POISON2,       GHOST,        NOT_VERY_EFFECTIVE
	db POISON2,       FAIRY,        SUPER_EFFECTIVE
